...
class Command(BaseCommand):
    ...
    def handle(self,*args,**options):
        ...
        all=soup.find_all('table',{'cols':'6'})[1].find_all('tr')
        for item in all:
            ...
            try:
                Game.objects.create(favorite=name_translation[favorite],line=line,underdog=name_translation[underdog],gamedate='monday')
            except:
                pass